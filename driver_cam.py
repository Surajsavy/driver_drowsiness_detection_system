...
but4=Button(frame,padx=5,pady=5,width=39,bg='white',fg='black',relief=GROOVE,command=blink,text='Detect Eye Blink With Sound',font=('helvetica 15 bold'))
but4.place(x=5,y=400)
